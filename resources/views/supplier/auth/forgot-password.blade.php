                ...
                <div class="auth-inner my-2">
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <form class="auth-forgot-password-form mt-2" action="{{ route('supplier.password.email') }}" method="POST">
                                @csrf
                                <div class="mb-1">
                            ...
                            <p class="text-center mt-2">
                                <a href="{{route('supplier.login')}}"> <i data-feather="chevron-left"></i> Back to login </a>
                            </p>
                        </div>
                    </div>
                    <!-- /Forgot Password basic -->
