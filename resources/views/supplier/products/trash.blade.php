    ...
    <div class="content-wrapper container-xxl p-0">
        ...
        <div class="content-body">
            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="mb-5">
                        <a href="{{route('supplier.products.index')}}" class="btn btn-sm btn-primary btn-rounded btn-fw">Back</a>
                    </div>
                                    ...
                                    @forelse ($products as $product)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('supplier.products.restore',$product->id)}}" method="POST">
                                                    @csrf
                                                    @method('put')
                                                    <button type="submit" class="btn btn-outline-info btn-min-width box-shadow-3 mr-1 mb-1 waves-effect">Restore</button>
                                                </form>
                                                <form action="{{route('supplier.products.force-delete',$product->id)}}" method="POST">
                                                    @csrf
                                                    @method('delete')
