                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('supplier.categories.index')}}">Categories</a>
                                </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                @endif
                            <div class="card-body">
                                <form class="form" action="{{route('supplier.categories.update',$category->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
