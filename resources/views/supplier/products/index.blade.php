    ...
    <div class="content-wrapper container-xxl p-0">
        ...
        <div class="content-body">
            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="mb-5">
                        <a href="{{route('supplier.products.create')}}" class="btn btn-sm btn-primary btn-rounded btn-fw mr-2">Create</a>
                        <a href="{{route('supplier.products.trash')}}" class="btn btn-sm btn-dark btn-rounded btn-fw">Trash</a>
                    </div>
                                ...
                                <tbody>
                                    @forelse ($products as $product)
                                        <tr>
                                            ...
                                            <td>{{$product->id}}</td>
                                            <td ><a href="{{route('supplier.products.show',$product->id)}}"> {{$product->name}} </a></td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('supplier.products.edit',$product->id)}}"
                                                    ...
                                                    <a href="{{route('supplier.products.add_variant',$product->id)}}"
