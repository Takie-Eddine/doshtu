            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-pills mb-2">
                        <!-- account -->
                        <li class="nav-item">
                            <a class="nav-link active" href="{{route('supplier.profile.update')}}">
                        ...
                        <!-- security -->
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('supplier.profile.security')}}">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-2 my-25">
                            ...
                            <form class="validate-form mt-2 pt-50" action="{{route('supplier.profile.update')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                                <div class="d-flex">
                                    <a href="#" class="me-25">
