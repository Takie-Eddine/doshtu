            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-pills mb-2">
                        ...
                        <!-- security -->
                        <li class="nav-item">
                            <a class="nav-link active" href="{{route('supplier.profile.security')}}">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-1">
                            ...
                            <!-- form -->
                            <form class="validate-form" action="{{route('supplier.profile.security.update')}}" method="POST">
                                @csrf
                                @method('patch')
                                <div class="row">
                                    <div class="col-12 col-sm-6 mb-1">
                                        ...
                                        <div class="input-group form-password-toggle input-group-merge">
                                            <input type="text" class="form-control" id="" name="username" placeholder="Enter Username" value="{{$admin->name}}" data-msg="Please current password" />
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 mb-1">
                                        <label class="form-label" for="email">Email </label>
                                        <div class="input-group form-password-toggle input-group-merge">
                                            <input type="email" class="form-control" id="" name="email" placeholder="email@email.com" value="{{$admin->email}}" data-msg="Please current password" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
