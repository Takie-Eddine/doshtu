    ...
    <div class="content-wrapper container-xxl p-0">
        ...
        <div class="content-body">
            ...
            <div class="row" id="basic-table">
                ...
                <div class="col-12">
                    <div class="mb-5">
                        <a href="{{route('supplier.complaints.newcomplaint')}}" class="btn btn-sm btn-primary btn-rounded btn-fw mr-2">Create</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="fw-bold">{{\Illuminate\Support\Str::limit(strip_tags($complaint->body), 50)}}
                                                    ...
                                                    ... <a href="{{route('supplier.complaints.view',$complaint->id) }}" class="btn btn-info btn-sm">Read More</a>
                                                    @endif</span>
                                            </td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group"
                                                                    ...
                                                                    <a href="{{route('supplier.complaints.respond',$complaint->id)}}"
                                                                    class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">send</a>


                                                                    <a href="{{route('supplier.complaints.view',$complaint->id)}}"
