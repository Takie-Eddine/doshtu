                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.companies.index')}}">Manufactories</a>
                                </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">Edit Manufactory</h4>
                            </div>
                                @if ($errors->any())
                                ...
                                <form class="form" action="{{route('admin.companies.update',$company->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 mb-1">
                                            ...
                                            <select name="country" id="country" class="select2 form-select" required>
                                                ...
                                                @foreach ($countries as $country => $value)
                                                    <option value="{{$country}}" {{$company->country == $country ? 'selected' : null}} >{{$value}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-12 col-sm-6 mb-1">
                                        ...
                                        {{-- <div class="col-12 col-sm-6 mb-1">
                                            ...
                                            <select name="supplier" id="country" class="select2 form-select" required>
                                        ...
                                        <div class="col-12 col-sm-6 mb-1">
                                            ...
                                            <select name="status" id="country" class="select2 form-select" >
                                                <option value="">Select Status</option>
                                                <option value="active" @selected($company->is_active == 'active')>Active</option>
                                                <option value="unactive" @selected($company->is_active == 'unactive')>Inactive</option>
                                            </select>
                                        </div>
                                        <div class="col-md-12 col-12">
                                            <div class="mb-1">
