        ...
        <div class="col-2">
            <div class="form-group">
                <select name="status" class="form-control">
                    ...
                    <option value="unactive" {{ old('status', request()->input('status')) == 'unactive' ? 'selected' : '' }}>Archived</option>
                </select>
            </div>
        </div>
        <div class="col-2">
            <div class="form-group">
                <select name="sort_by" class="form-control">
                    ...
                    <option value="company_name" {{ old('sort_by', request()->input('sort_by')) == 'company_name' ? 'selected' : '' }}>Name</option>
