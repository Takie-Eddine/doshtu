                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="first-name-column" class="form-control" placeholder="Arabic Name" name="name_ar" value="{{$attribute->getTranslation('name','ar')}}" />
                                            </div>
                                            @error('name_ar')
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="first-name-column">English Name</label>
                                                <input type="text" id="first-name-column" class="form-control" placeholder="English Name" name="name_en" value="{{$attribute->getTranslation('name','en')}}" />
                                            </div>
                                            @error('name_en')
                                                <span class="text-danger"> {{ $message }}</span>
                                            @enderror
