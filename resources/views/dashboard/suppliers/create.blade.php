...
@section('title','Create Supplier Owner')
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">Create Supplier Owner</h4>
                            </div>
                                @if ($errors->any())
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="email" id="first-name-column" class="form-control" placeholder="Email" name="email" value="{{old('email')}}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
