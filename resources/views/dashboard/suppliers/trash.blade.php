...
@section('title','Trash Supplier Owner')
    ...
    <div class="content-wrapper container-xxl p-0">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Suppliers Owners
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        <div class="content-body">
            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="mb-5">
                        <a href="{{route('admin.suppliers.index')}}" class="btn btn-sm btn-primary btn-rounded btn-fw">Back</a>
                    </div>
