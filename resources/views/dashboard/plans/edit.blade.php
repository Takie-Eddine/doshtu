                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="blog-edit-title" class="form-control" name="name_ar" value="{{$plan->getTranslation('name','ar')}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="mb-2">
                                                <label class="form-label" for="blog-edit-title">English Title</label>
                                                <input type="text" id="blog-edit-title" class="form-control" name="name_en" value="{{$plan->getTranslation('name','en')}}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" id="blog-edit-title" class="form-control" name="monthly_price" value="{{$plan->monthly_price}}" />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="mb-2">
                                                <label class="form-label" for="blog-edit-title">Annually Price</label>
                                                <input type="text" id="blog-edit-title" class="form-control" name="annualy_price" value="{{$plan->annual_price}}" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
                                                <label class="form-label">Arabic Description</label>
                                                <textarea name="description_ar" class="form-control summernote" >{!!$plan->getTranslation('description','ar')!!}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-2">
