...
@section('title','Edit E-Store Owner')
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">Edit E-store owner</h4>
                            </div>
                                @if ($errors->any())
                                ...
                                @endif
                            <div class="card-body">
                                <form class="form" action="{{route('admin.clients.update',$user->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="email" id="first-name-column" class="form-control" placeholder="Email" name="email" value="{{$user->email}}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
