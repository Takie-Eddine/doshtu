                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{route('admin.user.update',$admin->id)}}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="first-name-column" class="form-control" placeholder="Username" name="name" value="{{$admin->name}}" />
                                            </div>
                                                @error('name')
                                                    <span class="text-danger"> {{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="email" id="email-id-column" class="form-control" name="email" placeholder="Email" value="{{$admin->email}}"/>
                                            </div>
                                            @error('email')
                                                <span class="text-danger"> {{ $message }}</span>
                                            @enderror
