                                                ...
                                                <div class="col-md-12 col-12">
                                                    <div class="mb-2">
                                                        ...
                                                        <select id="default-select-multi{{rand(00,99)}}" class="select2 form-select opts" name="tags[]" multiple>
                                                            ...
                                                            @forelse ($tags as $tag)
                                                                <option value="{{$tag->id}}" {{ (collect(old('tags'))->contains($tag->name)) ? 'selected':'' }}>{{$tag->name}}</option>
                                                            @empty
                                                            @endforelse
                                                            </select>
                                                            @error('tags.0')
                                                ...
                                                <div class="d-flex flex-column flex-md-row">
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-1 col-md-6">
                                                            ...
                                                            <input type="number" id="default_price" name="selling_price" value="{{old('selling_price')}}" class="form-control"  />
                                                            @error('selling_price')
                                                                <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
