    ...
    <div class="content-wrapper container-xxl p-0">
        ...
        <div class="content-body">
            ...
            <div class="row" id="basic-table">
                <div class="col-12">
                    <div class="card-body">
                        <a href="{{route('user.role-permissions.create')}}" class="btn btn-sm btn-primary btn-rounded btn-fw mr-2">Create</a>
                    </div>
                    <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group"
                                                                    ...
                                                                    <a href="{{route('user.role-permissions.edit',$role->id)}}"
                                                                    class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">edit</a>

                                                                    <form action="{{route('user.role-permissions.delete',$role->id)}}" method="POST">
                                                                        @csrf
                                                                        @method('delete')
