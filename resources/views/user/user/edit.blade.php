                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{route('user.user.update',$user->id)}}" method="POST">
                                    ...
                                    <div class="row">
                                        {{-- <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="first-name-column" class="form-control" placeholder="First Name" name="first_name" value="{{$user->first_name}}" />
                                            </div>
                                            @error('first_name')
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="first-name-column" class="form-control" placeholder="Username" name="name" value="{{$user->name}}" />
                                            </div>
                                                @error('name')
                                                    <span class="text-danger"> {{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="password" id="password-column" class="form-control" value="{{$user->password}}" name="password" placeholder="Password" />
                                            </div>
                                            @error('password')
                                                    <span class="text-danger"> {{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="password" id="" class="form-control" value="{{$user->password}}" name="password_confirmation" placeholder="Confirm Password" />
                                            </div>
                                            @error('password')
                                                    <span class="text-danger"> {{ $message }}</span>
                                            @enderror
