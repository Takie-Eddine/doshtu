...
class ProductsController extends Controller
{
    ...
    public function create(){
        ...
        return view('supplier.products.create',compact('tags','categories'));
    ...
    public function store(Request $request){
        ...
        try{
            ...
            $product = Product::create([
                'company_id' => Auth::user('supplier')->company->id,
            ...
            DB::commit();
            return redirect()->route('supplier.products.index')->with([
            ...
            DB::rollback();
            return redirect()->route('supplier.products.index')->with($ex->getMessage());
        }
    ...
    public function edit($id){
        ...
        return view('supplier.products.edit', compact('product', 'tags'));
    }
    ...
    public function trash()
    {
        ...
        return view('supplier.products.trash',compact('products'));
    }
    ...
    public function restore(Request $request ,$id)
    {
        ...
        $product->restore();
        return redirect()->route('supplier.products.trash')->with([
    ...
    public function add_variant(Product $product){
        ...
        return view('supplier.products.variant',compact('product','attributes'));
    }
    ...
    public function store_variant(Request $request){
        ...
        try{
            ...
            if ($image = $request->file('image')) {
                ...
                $file_name = Str::slug($product->getTranslation('name','en')).".".rand(0,9).".".$image->getClientOriginalExtension();
                $path = public_path('/assets/product_images/' .$file_name);
